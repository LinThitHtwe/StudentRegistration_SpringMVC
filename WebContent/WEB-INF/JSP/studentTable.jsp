...
<form class="row g-3 mt-3 ms-2">
  ...
  <div class="col-auto">
    <button type="button" class="btn btn-danger mb-3" onclick="window.location.reload()">Reset</button>
              ...
              <script>
  const searchCourseId = document.getElementById('searchStudentName');
  ...
  <c:forEach items="${requestScope.studentList}" var="studentList">
    <tr>
      ...
      <td>
          ...
          <button type="button" class="btn btn-secondary mb-2" onclick="window.location.href='/OJT_Student_Spring_MVC/setupupdateStudent/${studentList.student_id}'">See More</button>
