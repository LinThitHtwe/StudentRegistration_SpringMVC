...
%>
        ...
        <div class="col-md-1" >
            <input type="button" class="btn-basic" id="lgnout-button" value="Log Out" onclick="location.href='/OJT_Student_Spring_MVC/homePage'">
        </div>        
    </div>
</div>
...
<form class="row g-3 mt-3 ms-2">
  ...
  function toggleSearchBtn() {
    if (searchCourseId.value.trim() !== '' || searchCourseName.value.trim() !== '') {
  ...
  searchCourseId.addEventListener('input', toggleSearchBtn);
  searchCourseName.addEventListener('input', toggleSearchBtn);
</script>
...
<div class="d-flex justify-content-start">
  <button type="button" class="btn btn-success me-2" onclick="window.location.href = '/OJT_Student_Spring_MVC/setupUpdateCourse/${courseList.courseId}'">Update</button>
</div>
