...
<a href="/OJT_Student_Spring_MVC/dashboard">Dashboard</a>
    ...
    <div id="sub_content">
    <form:form action="/OJT_Student_Spring_MVC/updateCourse" method="post" onsubmit="return validateForm(event)" modelAttribute="courseBean">
        ...
        <div class="row mb-4" style="display:none;">
            ...
            <div class="col-md-4">
                <form:input readonly="readonly" type="text" class="form-control" id="id" name="courseId" path="courseId"></form:input>
            </div>
            <div class="col-md-2 col-form-label" id="IDValidationMsg" style="display:none;color:red;"></div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <button type="submit" class="btn btn-secondary col-md-2"  onclick="validateForm(event)">Update</button>
        ...
        function validateForm() {
        	  ...
        	  var idValidationMsg = document.getElementById('IDValidationMsg');
        	  ...
        	  if (nameinput.trim() === '' && idinput.trim() === '') {
        	    ...
        	    idValidationMsg.textContent = 'Id Cannot Be Blank.';
        	    idValidationMsg.style.display = 'block';
