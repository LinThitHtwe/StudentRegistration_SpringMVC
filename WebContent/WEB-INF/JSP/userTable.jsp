...
<c:if test="${adminRole == null }">
  <button type="button" class="btn btn-success me-2" onclick="location.href = '';">Update</button></c:if>
   <c:if test="${userRole == null }">
 <a href="/OJT_Student_Spring_MVC/banUser/${userList.id }" class="btn btn-danger mb-3" id="deleteLink" id="deleteLink" data-bs-toggle="modal" data-bs-target="#exampleModal${userList.id}">Ban</a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h5 style="color: rgb(127, 209, 131);">Are you sure you want to ban <label style="color:red;">${userList.name }</label>? </h5>
      </div>
      <div class="modal-footer">
        <form action="/OJT_Student_Spring_MVC/banUser/${userList.id }" method="GET">
