...
<a href="/OJT_Student_Spring_MVC/dashboard">Dashboard</a>
    ...
    <div id="sub_content">
        <form:form action="/OJT_Student_Spring_MVC/updateStudent" method="post" enctype="multipart/form-data" modelAttribute="studentBean" onsubmit="return validateForm()">
            ...
            <div  style="color:red;text-align:center">${error }</div>
                ...
                <div class="col-md-4">
                    <form:input type="text" class="form-control" id="name" name="id" path="studentId" placeholder="Student's Name"></form:input>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <form:input type="text" class="form-control" id="name" name="studentName" path="studentName" placeholder="Student's Name"></form:input>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-check-inline">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
<form:input type="text" class="form-control" id="phone" name="phone" path="phone" placeholder="Phone Number" oninput="this.value = this.value.replace(/[^0-9]/g, '')"></form:input>
...
<div class="row mb-4">
    ...
    <div class="col-md-4">
        <form:select class="form-select" id="education" path="education">
            <form:option value="Bachelor of Information Technology" label="Bachelor of Information Technology" selected="${education == 'Bachelor of Information Technology'}" />
            <form:option value="Diploma in IT" label="Diploma in IT" selected="${education == 'Diploma in IT'}" />
            <form:option value="Bachelor of Computer Science" label="Bachelor of Computer Science" selected="${education == 'Bachelor of Computer Science'}" />
        </form:select>
    </div>
</div>
        ...
        <c:forEach items="${requestScope.courseListForCheckbox}" var="courseListForCheckbox">
            <div class="form-check-inline col-md-2">
                <input class="form-check-input" type="checkbox" name="course[]" id="gridRadios1" value="${courseListForCheckbox.courseId}"
                    ${selectedCourses.contains(courseListForCheckbox.courseName) ? 'checked' : ''}>
                <label class="form-check-label" for="gridRadios1">
...
<div class="row mb-4">
    ...
    <label for="name" class="col-md-2 col-form-label">Photo</label>
    <div class="col-md-4">
    							<form:input onchange="readFile(this)" type="file" class="form-control"
								id="photo" name="photo" path="photo" accept="image/*"></form:input>
       <!--  <img id="preview" src="data:image/png;base64,${studentData.student_photo}" alt="Student Photo" style="width: 200px; height: 200px;"> -->
    </div>
</div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
    <a href="/OJT_Student_Spring_MVC/studentTable" class="btn btn-danger">
        Back
    </a>
...
function redirectToReject() {
	  ...
	  var url = '/OJT_Student_Spring_MVC/deleteStudent/' + userId;
