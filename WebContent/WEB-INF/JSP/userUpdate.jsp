...
<a href="/OJT_Student_Spring_MVC/dashboard">Dashboard</a>
    ...
    <div id="sub_content">
        <form:form  action="/OJT_Student_Spring_MVC/updateprofile" method="post" onsubmit="return validateForm()" modelAttribute="accountBean">

        <h2 class="col-md-6 offset-md-2 mb-5 mt-4">Edit Profile</h2>
    ...
    setTimeout(function() {
      message.style.display = 'none';
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <form:input type="email" readonly="true" class="form-control" name="email" id="email" path="email"></form:input>
            </div>
        </div>
                <div class="row mb-4">
            <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="password" class="form-control" name = "newPassword" id="newPassword" placeholder="New Passowrd">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            -->
            <button type="button" class="btn btn-secondary col-md-2 " onclick="window.location.href = '/OJT_Student_Spring_MVC/homePage';">
                Back
            </button>
